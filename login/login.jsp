...
<head>
    ...
    <link rel="stylesheet" href="css/login.css?v=201804121244">
...
<body>
    ...
    <div class="page_next">
        ...
        <footer>
            <p>如何获取分行码？</p>
            <p>分行码是轩天合作经纪门店的唯一标识，可咨询您的分行经理获取唯一的邀请码，完善提交后即可报备/带看，赚取佣金，并享受便捷透明的结佣方式。 </p>
...
<script type="text/javascript" src="js/login.js?v=201804121244"></script>
</body>
</html>